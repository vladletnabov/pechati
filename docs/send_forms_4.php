...
/*po filialam*/
if($_POST[adress]){
	//if ($_POST[adress]=="м. Алексеевская"){$mail->AddAddress('mdv@pechati.ru', '');}
	//elseif ($_POST[adress]=="м. Водный стадион"){$mail->AddAddress('vs@epechati.ru', '');}
	if ($_POST[adress]=="м. Арбатская"){$mail->AddAddress('5454842@mail.ru', '');}	
	elseif ($_POST[adress]=="м. Алексеевская"){$mail->AddAddress('mdv@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Авиамоторная"){$mail->AddAddress('perovo@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Алтуфьево"){$mail->AddAddress('t6652256@yandex.ru', '');}
	//elseif ($_POST[adress]=="м. Аэропорт"){$mail->AddAddress('aeroport@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Бабушкинская"){$mail->AddAddress('mdv@pechati.ru', '');}
	...
	//elseif ($_POST[adress]=="м. Бульвар Дмитрия Донского"){$mail->AddAddress('zakaz@mpechati.ru', '');}
	elseif ($_POST[adress]=="м. ВДНХ"){$mail->AddAddress('mdv@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Водный стадион"){$mail->AddAddress('vs@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Динамо"){$mail->AddAddress('bgv@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Домодедовская"){$mail->AddAddress('marino@pechati.ru', '');}
	...
	elseif ($_POST[adress]=="м. Ленинский пр-т"){$mail->AddAddress('l1@pechati.ru', '');}
	//elseif ($_POST[adress]=="м. Люблино"){$mail->AddAddress('marino@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Братиславская"){$mail->AddAddress('marino@pechati.ru', '');}
	...
	elseif ($_POST[adress]=="м. Октябрьская"){$mail->AddAddress('taganka@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Октябрьское поле"){$mail->AddAddress('bgv@pechati.ru', '');}	
	elseif ($_POST[adress]=="м. Пионерская"){$mail->AddAddress('t5007583@yandex.ru', '');}
	elseif ($_POST[adress]=="м. Петровско-Разумовская"){$mail->AddAddress('pr@pechati.ru', '');}
	//elseif ($_POST[adress]=="м. Печатники"){$mail->AddAddress('zakaz@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Пражская"){$mail->AddAddress('et12@bk.ru', '');}
	elseif ($_POST[adress]=="м. проспект Мира"){$mail->AddAddress('5176723@mail.ru', '');}
	elseif ($_POST[adress]=="м. Преображенская площадь"){$mail->AddAddress('preo@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Румянцево"){$mail->AddAddress('9251254555@mail.ru', '');}
	...
	//elseif ($_POST[adress]=="м. Тушинская"){$mail->AddAddress('zakaz@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Тульская"){$mail->AddAddress('pr@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Ул. 1905 года"){$mail->AddAddress('bgv@pechati.ru', '');}
	//elseif ($_POST[adress]=="м. Царицино"){$mail->AddAddress('et05@bk.ru', '');}
	elseif ($_POST[adress]=="м. Цветной бульвар"){$mail->AddAddress('5454842@mail.ru', '');}
	elseif ($_POST[adress]=="м. Щелковская"){$mail->AddAddress('SLK@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Щукинская"){$mail->AddAddress('bgv@pechati.ru', '');}
	...
	elseif ($_POST[adress]=="м. Южная"){$mail->AddAddress('chertanovo@pechati.ru', '');}
	...
	elseif ($_POST[adress]=="Зеленоград"){$mail->AddAddress('6643718@mail.ru', '');}
	elseif ($_POST[adress]=="р-н Солцево"){$mail->AddAddress('sol@pechati.ru', '');}
...
if($_POST[adress]){
	...
	elseif ($_POST[adress]=="м. Пражская"){$mail->AddAddress('bgv@pechati.ru', '');}
	elseif ($_POST[adress]=="м. проспект Мира"){$mail->AddAddress('mdv@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Преображенская площадь"){$mail->AddAddress('preo@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Румянцево"){$mail->AddAddress('9251254555@mail.ru', '');}
	//elseif ($_POST[adress]=="м. Строгино"){$mail->AddAddress('strogino@pechati.ru', '');}
	elseif ($_POST[adress]=="м. Таганская, м. Марксисткая"){$mail->AddAddress('taganka@pechati.ru', '');}
