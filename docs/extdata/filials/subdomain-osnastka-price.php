...
<table cellpadding="10" cellspacing="0" border="0" align="center">
		...
		<td width="100%">
			<div style="clear:both; width:100%; margin:0;padding:0">
				<div class="osnatka-icon" style="width:24%; margin:0;padding:0;display:inline;float:left;">
					<IMG border=0 src="http://pechati.ru/pics/uslugi/colop_printer_r40_100x133.jpg" width=100 height=133 onclick="runEffect(1);">
				...
				<div class="osnatka-icon" style="width:24%; margin:0;padding:0;display:inline;float:left;">
					<IMG border=0 src="http://pechati.ru/pics/uslugi/shiny-s-843.jpg" width=100 height=133 onclick="runEffect(2);">
				...
				<div class="osnatka-icon" style="width:24%; margin:0;padding:0;display:inline;float:left;">
					<IMG border=0 src="http://pechati.ru/pics/uslugi/grm-4927.jpg" width=100 height=133 onclick="runEffect(3);">
				...
				<div class="osnatka-icon" style="width:24%; margin:0;padding:0;display:inline;float:left;">
					<IMG border=0 src="http://pechati.ru/pics/uslugi/colop-r3040.jpg" width=100 height=133  onclick="runEffect(4);">
				...
				<div id="osnastka1" class="oshastka-akkord">
					<div>
						<img src="http://pechati.ru/extdata/images/close-icon.png" style="float:right; cursor:pointer;" onClick="closeOsnastka();" alt="Закрыть"/>
					</div>
	...
	<tr valign="top" align="center">
		<td>
			<div style="clear:both; width:100%; margin:0;padding:0">
				<div class="osnatka-icon" style="width:24%; margin:0;padding:0;display:inline;float:left;">
					<IMG border=0 src="http://pechati.ru/pics/uslugi/met_classic_100x133.jpg" width=100 height=133 onclick="runEffect(5);">
				...
				<div class="osnatka-icon" style="width:24%; margin:0;padding:0;display:inline;float:left;">
					<IMG border=0 src="http://pechati.ru/pics/uslugi/met_techno_100x133.jpg" width=100 height=133 onclick="runEffect(6);">
				...
				<div class="osnatka-icon" style="width:24%; margin:0;padding:0;display:inline;float:left;">
					<IMG border=0 src="http://pechati.ru/pics/uslugi/plasm_gerb40_100x133.jpg" width=100 height=133 onclick="runEffect(7);">
				...
				<div class="osnatka-icon" style="width:24%; margin:0;padding:0;display:inline;float:left;">
					<IMG border=0 src="http://pechati.ru/pics/uslugi/elit_osn.jpg" width=100 height=133  onclick="runEffect(8);">
