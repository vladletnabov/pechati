...
(function($){
    ...
    $.fn.skifGallerySliderSqstamp= function(options) {
        ...
        //alert(uniqID);
        var elementID = 'skifgalleryslidersqstamp' + String(uniqID);
        ...
        return this.each(function(options) {
            ...
            //$elItem.paddings(15);
            //alert($('.carItem').height());
            //$this.max-height(Number($('.carItem').height())*3);
