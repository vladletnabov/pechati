...
<table cellpadding="0" cellspacing="0" border="0" width="990" height="100%" align="center">
	<tr>
		<td bgcolor="#ffffff"  background="http://pechati.ru/i/bg1-c.jpg" style="background-repeat: repeat-y; height:155px">
			<div style="height:150px; width:945px; margin-top:-5px; margin-left: 39px; margin-right: -100px; background-color:#0f0f47; box-shadow: 5px 2px 5px 2px #7f7f7f;">
				...
				<div style="background-image:url(http://pechati.ru//extdata/images/paper2.png); width:250px; max-height:194px; height:194px; align:center;float: left;position: relative; margin-left:-60px; ">
					<a href="/" style="text-decoration:none;">
						<img src="http://pechati.ru/extdata/images/pechati-ru.png" style="margin: 10px 0 0 60px;" /><br />
					...
					<div id="contacts" style="width:600px; float: left;">
						...
						<div style="padding:5px 0 0 35px;">
							<div style="margin:5px; width:250px;float:left;display: inline;">
								<i class="icon2-home" style="float:left;margin-right: 10px;"></i> <div> <a style="color: #efefef; font-size: 1em; text-decoration: none;"><?php echo $filialDataListCP1251[$curFilial]['addrRegion']?>, <?php echo $curFilial ?> <br /><?php  echo $filialDataListCP1251[$curFilial]['addrStreet'] ?> <?php  echo $filialDataListCP1251[$curFilial]['addrHouse'] ?></a></div>
	...
	<tr valign="top">
		<td height="100%" bgcolor="#ffffff" background="http://pechati.ru/i/bg1-c.jpg" style="background-repeat: repeat-y;">
			<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%" background="http://pechati.ru/i/bg2-c.jpg" style="background-position: top right; background-repeat: repeat-y;">
				<tr valign="top">
					<td width="990">
...
<form name="form1" id="form1" method="post" action="/send_forms_4.php" enctype="multipart/form-data">
	...
	<tr>
		<td><img src="http://pechati.ru/i/0.gif" width="1" height="1" alt=""></td>
	</tr>
	<tr>
		<td style="border: 1px solid #eeeafb;">
	...
	<tr>
		...
		<?php require_once "../../../extdata/filials/subdomain-sendform-price.php" ?>
		</td>
	</tr>
</form>
	<tr>
...
<!-- Content -->
	...
	<tr>
		<td><img src="http://pechati.ru/i/btm1-c.jpg" width="990" height="30" alt=""></td>
	</tr>
	<tr>
		<td class="btm1-c">
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr valign="top">
					...
					<td width="80" nowrap><a href="/"><strong>главная</strong></a></td>
					<td width="110" nowrap><a href="/"><strong>контакты</strong></a></td>
				</tr>
			</table>
		</td>
	</tr>
