		...
		<ul class="skifcarousel">
			...
			<li><div>
				...
				<div class="text-slider2">
					...
					<div class="description-slider">Для больших штампов<BR />Colop R3040</div>
				</div>
			</div></li>
			<li><div>
				...
				<div class="text-slider2">
					...
					<div class="description-slider">Металлическая, для штампов<BR />Colop S3900 (85х50 мм)</div>
				</div>
			</div></li>
			<li><div>
				...
				<div class="text-slider2">
					...
					<div class="description-slider">Для штампа<BR />Shiny Heavy Duty H6008</div>
				</div>
			</div></li>
			<li><div>
				...
				<div class="text-slider2">
					<div class="title-slider">1 000 р.</div>
					<div class="description-slider">Для круглой печати<BR />Shiny Heavy Duty H6009</div>
				</div>
			</div></li>
		</ul>
