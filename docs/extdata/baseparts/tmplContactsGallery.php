...
<form name="form1" id="form1" method="post" action="/send_forms_4.php" enctype="multipart/form-data">
	...
	<tr>
		...
		<p style="text-align: left;"> <img src="/pics/stamp-consist.jpg" width="300" alt="Из чего состоит печать" style="float:left;"><!--<img src="/pics/flashin.jpg" width="500" alt="Из чего состоит печать" style="float:left;">--></p><p style="clear:both;"></p>
		...
		<?php require_once "../extdata/filials/begovaya-clishe-price2test.php"; 
		...
		<?php require_once "../extdata/baseparts/stamp-gallery.php"; 
		?>
		</td>
	</tr>
	<tr>
