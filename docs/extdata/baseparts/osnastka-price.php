		...
		<td>
			<div style="clear:both; width:100%; margin:0;padding:0">
				...
				<div class="osnatka-icon" style="width:24%; margin:0;padding:0;display:inline;float:left;">
					...
					<p>Эксклюзивные оснастки<BR><input type="Radio" name="osnast" value="Эксклюзивные оснастки" onClick="price2 = 1300; count_price();" id="osnast6"> <label for="osnast6">1300 р.</label></p>
				</div>
				<div class="osnatka-icon" style="width:24%; margin:0;padding:0;display:inline;float:left;">
				...
				<div class="osnatka-icon" style="width:24%; margin:0;padding:0;display:inline;float:left;">
					...
					<p>Элитные оснастки<BR>от 4000 р.</p>
				</div>
