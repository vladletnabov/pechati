<!--<p align="center"><h3>Автоматическая оснастка</h3></p>
			<table cellpadding="5" cellspacing="0" border="0" width="99%" align="center">
				<tr valign="top" align="center">
					<td width="33%">
<p><img src="../pics/uslugi/colop_printer_r40.gif" border="0"></p>
<p>Круглая R 40mm.<br>
Цена: 450 р.</p>
					</td>
					<td width="33%">
<p><img src="../pics/uslugi/shiny-r542.jpg" width="150" height="200" alt=""></p>
<p>Автоматическая оснастка для круглой печати.<br>
Цена: 450 р.</p>
					</td>
					<td width="33%">
<p><img src="../pics/uslugi/color-r2045.jpg" width="150" height="200" alt=""></p>
<p>Печать с усиленной конструкцией (ДЛЯ ПЕЧАТЕЙ ПО ГОСТ).<br>Цена: 1 500 р.</p>
					</td>
				</tr>
			</table>
<hr size="1" color="#cccccc">
			<table cellpadding="5" cellspacing="0" border="0" width="99%" align="center">
				<tr valign="top" align="center">
					<td width="33%">
<p><img src="../pics/uslugi/shiny-s542.jpg" width="150" height="200" alt=""></p>-->
<!--<p>Автоматическая оснастка для круглой печати.<br>Цена: 400 р.</p>-->
<!--<p>Автоматическая оснастка для круглой печати.<br>Цена: 450 р.</p>
					</td>
					<td width="33%">
<p><img src="../pics/uslugi/colop-poket-stamp-r40.jpg" width="150" height="200" alt=""></p>
<p>Colop Pocket Stamp R40.<br>Цена: 700 р.</p>
					</td>
					<td width="33%">
<p><img src="../pics/uslugi/shiny-sq42.jpg" width="150" height="200" alt=""></p>
<p>Полуавтоматическая оснастка для печатей и штампов.<br>Цена: 400 р.</p>
					</td>
				</tr>
			</table>
-->
	...
	<!--	<div>
		...
		<div>
			<div class="img-slider">
				...
				<div class="text-slider2">
					<div class="title-slider">400 р.</div>
					<div class="description-slider"><label><input type="radio" name="osnast" onClick="price2 = 400; count_price();" value="Печать Shiny SQ42" />Полуавтоматическая оснастка <br />Shiny SQ42 для печатей и штампов</label></div>
				</div>
			</div>
		</div>
	</div>
