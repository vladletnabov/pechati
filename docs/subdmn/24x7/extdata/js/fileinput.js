...
function fileInputFormQuick(fi_container_class, fi_button_class, fi_filename_class, fi_button_text) {
	...
	fi_button_text		=	fi_button_text		||	''; // Text inside the button
	...
	// String to append
	var fi_str = '<div class="'+fi_container_class+'"><div class="'+fi_button_class+'"><i class="icon-folder-open" style="margin:5px 0 0 3px;"></i>'+fi_button_text+'</div><div class="'+fi_filename_class+'"></div></div>';
