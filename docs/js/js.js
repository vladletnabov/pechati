...
document.getElementById('cont2_35').onclick=function(){op(35)};
document.getElementById('cont2_36').onclick=function(){op(36)};
document.getElementById('cont2_37').onclick=function(){op(37)};
document.getElementById('cont2_38').onclick=function(){op(38)};
document.getElementById('cont2_39').onclick=function(){op(39)};
document.getElementById('cont2_40').onclick=function(){op(40)};
document.getElementById('cont2_41').onclick=function(){op(41)};
document.getElementById('cont2_42').onclick=function(){op(42)};
document.getElementById('cont2_43').onclick=function(){op(43)};
document.getElementById('cont2_44').onclick=function(){op(44)};
document.getElementById('cont2_45').onclick=function(){op(45)};
