(function($){
	...
	$.fn.skifCarousel = function(options) {
		...
		//alert(uniqID);
		var elementID = 'skifcarousel' + String(uniqID);
		$(this).attr('id', elementID);
		settings.btnNext = 'btnNext' + String(uniqID);
		settings.btnPrev = 'btnPrev' + String(uniqID);
		var divNext = "<div class=\"btnNext " + settings.btnNext + "\" />";
		var divPrev = "<div class=\"btnPrev " + settings.btnPrev + "\" />";
		$(this).append(divNext);
		$(this).append(divPrev);
		settings.btnNext = '.'+settings.btnNext;
		settings.btnPrev = '.'+settings.btnPrev;
