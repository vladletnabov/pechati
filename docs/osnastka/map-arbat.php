		...
		<div id="map">
			...
			<script type="text/javascript">
				YMaps.jQuery(window).load(function () {
					var map = new YMaps.Map(YMaps.jQuery("#YMapsID-5816")[0]);
					map.setCenter(new YMaps.GeoPoint(37.601112,55.752445), 16, YMaps.MapType.MAP);
				   ...
				   map.addOverlay(createObject("Placemark", new YMaps.GeoPoint(37.59918,55.752227), "constructor#pmdbmPlacemark", "м. Арбатская. Розница.<br/>Тел.: (495) 545-48-42<br/>ул. Арбат, д. 4 стр 1-1А, офис 48"));
			...
			<div id="YMapsID-5816" style="width:600px;height:450px"></div>
