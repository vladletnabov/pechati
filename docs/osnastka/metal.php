	...
	<div id="center">
		...
		<div id="list">
			<? list_full( array(
				...
				array("Компакт", "1700", "/osnastka/data/img/items/metal_kr_kompakt.gif"),
				array("НЛО", "1300", "/osnastka/data/img/items/metal_kr_nlo2.gif"),
				...
				array("Диско", "1300", "/osnastka/data/img/items/metal_kr_disco.gif"),
				array("НЛО/Диско", "2300", "/osnastka/data/img/items/metal_kr_nlodisco2.gif"),
