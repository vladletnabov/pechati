...
<div class="container">
	...
	<div id="center">
		...
		<div id="map">
			<p>м. Аэропорт. Только оптовые заказы <br>
				Тел.: +7 (495) 961-4-961<br />
				Ленинградский проспект, д. 37 к.6<br />
				Почта: <a href="mailto:zakaz@pechati.ru">zakaz@pechati.ru</a></p>
			...
			<script type="text/javascript">
				YMaps.jQuery(window).load(function () {
				   ...
				   map.addOverlay(createObject("Placemark", new YMaps.GeoPoint(37.543048,55.793397), "constructor#pmdbmPlacemark", "м. Аэропорт. Только оптовые заказы <br/>Тел.: +7 (495) 961-4-961<br/>Ленинградский проспект, д. 37 к.6"));
