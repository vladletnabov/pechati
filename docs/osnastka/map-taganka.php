...
<div class="container">
	...
	<div id="center">
		...
		<div id="map">
			<p>м.  Таганская. Розница<br />
				Тел.: +7(495) 506-22-77<br />
				ул. Большие каменщики д.1<br />
				Почта: <a href="mailto:taganka@pechati.ru">taganka@pechati.ru</a></p>
			...
			<script type="text/javascript">
				YMaps.jQuery(window).load(function () {
				   ...
				   map.addOverlay(createObject("Placemark", new YMaps.GeoPoint(37.654175,55.739715), "constructor#pmdbmPlacemark", "м. Таганская. Розница<br/>Тел.: +7(495) 506-22-77<br/>ул. Большие каменщики д.1"));
