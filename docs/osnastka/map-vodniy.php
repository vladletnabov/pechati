...
$title = "Схема проезда: Водный стадион";
$description = "";
$keywords = "";
	...
	<div id="center">
		...
		<div id="map">
			<p>
				...
				ул. Смольная, д. 2<br />
				Почта: <a href="mailto:vs@pechati.ru">vs@pechati.ru</a></p>
...
<script type="text/javascript">
    YMaps.jQuery(window).load(function () {
       ...
       map.addOverlay(createObject("Placemark", new YMaps.GeoPoint(37.500917,55.844753), "constructor#pmlbmPlacemark", "<br/>м. Водный стадион<br/>Тел.: +7 (495) 979-88-73<br/>ул. Смольная, д. 2"));
